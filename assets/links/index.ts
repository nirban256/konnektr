...
import { BsThreeDots, BsQuestionDiamondFill, BsFillGearFill } from "react-icons/bs";
...
export const menuItems = [
  ...
  { id: 2, label: "Konnektions", icon: FaUserPlus, link: "/konnektions", active: true },
  { id: 3, label: "Communities", icon: FaUsers, link: "/communities", active: false },
...
export const menuItems1 = [
  { id: 4, label: "Settings", icon: BsFillGearFill, link: "/settings", active: true },
  { id: 6, label: "Notifications", icon: FaBell, link: "/notifications", active: true },
];
