...
const Home: NextPage = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-start  lg1100:px-[2%] lg1200:px-[3%] lg1300:px-[5%] lg1350:px-[10%] xl1500:px-[13%] xl1650:px-[15%] xl1750:px-[17%] xl1950:px-[20%] ">
      <DashboardLayout>
        <div className="w-full h-full flex flex-col sm:flex-row items-start justify-between bg-white pb-16  sm:pb-0 box-border overflow-hidden">
          <div className="h-full w-full flex flex-col items-center justify-start overflow-y-scroll scrollbar-hide pr-0 sm:pr-1 box-border">
            ...
            <div className="w-[99%] sticky h-auto sm:min-h-[120px] max-h-[128px] rounded-[25px] bg-bgCover flex flex-col items-center justify-evenly sm:justify-between py-2 sm:py-0 box-border mt-2">
              ...
              <div className="w-[93%] sm:w-[95%]  h-[45%] flex items-center justify-between gap-x-1 mt-4">
                ...
                <SearchItem
                  name="Video"
                  image={"/assets/svg/videocircle.svg"}
                />
                <SearchItem
                  name="Event"
                  image={"/assets/svg/calendaredit.svg"}
                />
          ...
          <section className=" hidden h-full w-[35%] min-w-[350px] lg:flex flex-col items-center justify-start">
            ...
            <div className="w-full h-[30vh] flex flex-col items-center justify-evenly border-[1px] border-goldBorder bg-goldBg rounded-[30px] mt-2 px-[8%] py-[3%] box-border">
              ...
              <p className="text-[0.8rem] text-lightGold font-light mt-1 mb-3 ">
                Konnektr is still in the beta phase,things may break,please
                handle us with care.
              </p>
              <p className="text-[0.9rem] font-semibold text-profileDesc">
                © 2022 konnektr Privacy Discord Donate Status Vote Feedback
                hanks GitHub▲ Powered by Vercel
              </p>
            </div>
          </section>
        </div>
