...
const konnektions = () => {
  ...
  return (
    <DashboardLayout>
      <div className="w-full min-h-[100vh] bg-bgGrey1 flex flex-col items-center justify-start">
        <div className="w-[100%] h-[100%] bg-transparent flex flex-col items-center box-border pb-6 pt-3">
          <div className="flex items-start justify-start w-full h-[45px] pl-5 box-border">
            {searchBy === "Name" ? (
              <TextInput
                sx={{ color: "white" }}
                variant="unstyled"
                className="w-[55vw] sm:w-[40vw] text-white bg-bgGrey2 rounded-md pl-3 box-border"
              ...
              <MultiSelect
                ...
                classNames={{
                  input:
                    "w-[50vw] sm:w-[40vw] text-white bg-bgGrey2 rounded-md pl-3 box-border border-0 selected:text-black",
                  dropdown:
            ...
            <Select
              ...
              classNames={{
                dropdown:
                  "w-28 text-white bg-bgGrey2 hover:bg-bgGrey2 border-0",
                input:
                  "rounded-md bg-bgInput hover:bg-bgInput border-2 border-selectBorder ml-5 h-10 min-w-[120px] w-[10vw] text-white selected:bg-white",
          ...
          <h1 className="text-[18px] ml-2 sm:ml-5 sm:text-heading mb-1  text-white font-normal self-start">
            Top Picks
          </h1>
          <div className="w-[100%] lg:h-[40%] flex overflow-x-scroll gap-x-7 scrollbar-hide pl-5 px-[10px] box-border">
            {/* Carousel */}
            <Carousel
              className="h-full"
              slideGap="md"
          ...
          <h1 className="text-[18px] ml-2 sm:ml-5 sm:text-heading my-1 text-white font-normal self-start">
            Users
          </h1>
