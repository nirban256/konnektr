  ...
  return (
    <DashBoardLayout>
      <div className="w-[100%] h-[100vh] flex flex-col sm:flex-row items-center justify-start lg:items-start lg:justify-between bg-white pb-16 sm:pb-0 box-border overflow-hidden ">
        <Header />
        <div className="h-[90%] w-full sm:w-[68%] flex flex-col items-center justify-start overflow-y-scroll scrollbar-hide pr-0 sm:pr-1 py-0 lg:py-2 box-border">
          <div className="relative w-full h-[100vh] flex flex-col items-center justify-start bg-bgCover rounded-[25px] py-4 box-border mt-0 lg:mt-5">
            <div className="sticky top-2 z-[1000] w-[95%] h-[10%] min-h-[55px] max-h-[65px] bg-white rounded-[10px] flex items-center justify-between px-2 box-border">
            ...
            {iscallStarted && !isModalMinimized && (
              <CallModal
                ...
                className="sticky top-[65px] mb-2 z-[1000]"
                status="Calling"
                mobile={true}
                name={"Shivrajj"}
            ...
            <ScrollToBottom
              ...
              scrollViewClassName="relative flex flex-col items-center w-full h-[100%] box-border scrollbar-hide py-2 pr-2"
            ...
            <form
              ...
              className="fixed lg:relative  bottom-0 z-[1000] w-[97%] h-[10%] min-h-[50px] max-h-[60px] bg-white rounded-[10px] flex items-center justify-between px-2 box-border"
            >
        ...
        <section className=" hidden h-full w-[30%] min-w-[320px] sm:flex flex-col items-center justify-start lg1100:mr-[1%] lg1200:mr-[1%] lg1300:mr-[2%] xl1400:mr-[10%] xl1500:mr-[16%] pt-2">
